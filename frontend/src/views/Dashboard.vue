    ...
    <main class="min-h-screen">
        ...
        <div class="p-8 space-y-8">
            ...
            <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <!-- KPI Cards... -->
                <div class="bg-surface-containerest dark:bg-slate-900 p-6 rounded-2xl shadow-sm shadow-red-500/5 border border-red-500/5 dark:border-red-500/10 hover:shadow-md transition-shadow opacity-0 animate-slide-up-fade" style="animation-delay: 0.1s">
                    ...
                    <p class="text-2xl font-black text-on-surface dark:text-slate-100 tracking-tight mt-1">{{ isLoading ? '...' : (stats.totalPatients ? stats.totalPatients.toLocaleString() : '24,892') }}</p>
                </div>

                <div class="bg-surface-containerest dark:bg-slate-900 p-6 rounded-2xl shadow-sm shadow-red-500/5 border border-red-500/5 dark:border-red-500/10 hover:shadow-md transition-shadow opacity-0 animate-slide-up-fade" style="animation-delay: 0.2s">
                    <div class="flex justify-between items-start mb-4">
                    ...
                    <p class="text-2xl font-black text-on-surface dark:text-slate-100 tracking-tight mt-1">{{ isLoading ? '...' : (stats.totalStaff || stats.staffOnline) }}</p>
                </div>
                <div class="bg-surface-containerest dark:bg-slate-900 p-6 rounded-2xl shadow-sm shadow-red-500/5 border border-red-500/5 dark:border-red-500/10 hover:shadow-md transition-shadow opacity-0 animate-slide-up-fade" style="animation-delay: 0.3s">
                    <div class="flex justify-between items-start mb-4">
                        <div class="p-2 bg-primary-container dark:bg-red-900/40 rounded-xl">
                    ...
                    <p class="text-2xl font-black text-on-surface dark:text-slate-100 tracking-tight mt-1">{{ isLoading ? '...' : stats.activeChats }}</p>
                </div>
            </section>
            ...
            <section class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <!-- Main Line Chart -->
                <div class="lg:col-span-2 bg-surface-containerest dark:bg-slate-900 p-8 rounded-3xl shadow-sm border border-red-500/5 dark:border-red-500/10">
                    <div class="flex items-center justify-between mb-8">
                        <div>
                            <h2 class="text-xl font-bold tracking-tight text-on-surface dark:text-slate-100">Patient Admission Trends</h2>
                    ...
                    <div class="h-64 flex items-end gap-3 px-4 relative">
                        ...
                        <div class="flex-1 bg-primary-container dark:bg-red-900/40 rounded-t-lg h-[40%] hover:bg-primary transition-colors cursor-pointer group relative">
                        ...
                        <div class="flex-1 bg-primary-container dark:bg-red-900/40 rounded-t-lg h-[60%] hover:bg-primary transition-colors"></div>
                        <div class="flex-1 bg-primary-container dark:bg-red-900/40 rounded-t-lg h-[45%] hover:bg-primary transition-colors"></div>
                        <div class="flex-1 bg-primary-container dark:bg-red-900/40 rounded-t-lg h-[75%] hover:bg-primary transition-colors"></div>
                        <div class="flex-1 bg-primary-container dark:bg-red-900/40 rounded-t-lg h-[90%] hover:bg-primary transition-colors"></div>
                        <div class="flex-1 bg-primary-container dark:bg-red-900/40 rounded-t-lg h-[55%] hover:bg-primary transition-colors"></div>
                        <div class="flex-1 bg-primary-container dark:bg-red-900/40 rounded-t-lg h-[70%] hover:bg-primary transition-colors"></div>
                        <div class="flex-1 bg-primary-container dark:bg-red-900/40 rounded-t-lg h-[85%] hover:bg-primary transition-colors"></div>
                        <div class="flex-1 bg-primary-container dark:bg-red-900/40 rounded-t-lg h-[65%] hover:bg-primary transition-colors"></div>
                        <div class="flex-1 bg-primary-container dark:bg-red-900/40 rounded-t-lg h-[80%] hover:bg-primary transition-colors"></div>
                        <div class="flex-1 bg-primary-container dark:bg-red-900/40 rounded-t-lg h-[95%] hover:bg-primary transition-colors"></div>
                        <div class="flex-1 bg-primary-container dark:bg-red-900/40 rounded-t-lg h-[75%] hover:bg-primary transition-colors"></div>
                    </div>
                ...
                <!-- Pie Chart -->
                <div class="bg-surface-containerest dark:bg-slate-900 p-8 rounded-3xl shadow-sm border border-red-500/5 dark:border-red-500/10">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2"><span class="w-2 h-2 rounded-full bg-primary"></span><span class="text-xs font-medium text-zinc-600 dark:text-zinc-300">Admin</span></div><span class="text-xs font-bold text-on-surface dark:text-slate-100">{{ stats.staffDistribution.Emergency }}</span>
                        </div>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2"><span class="w-2 h-2 rounded-full bg-secondary"></span><span class="text-xs font-medium text-zinc-600 dark:text-zinc-300">Doctor</span></div><span class="text-xs font-bold text-on-surface dark:text-slate-100">{{ stats.staffDistribution.Cardiology }}</span>
                        </div>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2"><span class="w-2 h-2 rounded-full bg-tertiary"></span><span class="text-xs font-medium text-zinc-600 dark:text-zinc-300">Nurse & Other</span></div><span class="text-xs font-bold text-on-surface dark:text-slate-100">{{ (stats.staffDistribution.General + stats.staffDistribution.Other) || 0 }}</span>
                        </div>
                    </div>
                </div>
            </section>
        ...
        data() {
            return {
                ...
                stats: {
                    ...
                    staffOnline: 0,
                    activeChats: 0,
                    staffDistribution: { Emergency: 0, Cardiology: 0, General: 0, Other: 0 }
                },
                isLoading: false
            }
        },
